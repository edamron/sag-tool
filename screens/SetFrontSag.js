...
const SetFrontSag = ({ route, navigation }) => {
	...
	const getTargetLow = () => Math.round(front * 0.28);
	const getTargetHigh = () => Math.round(front * 0.33);
	...
	return (
		<View style={styles.container}>
			...
			>
				...
				<CollapseBody style={styles.collapseBody}>
					<Text style={styles.bodyText}>
						Now, we need to get your 'free length'...the length of
						the suspension fully extended. To do this, we'll be
						measuring from the wheel axle upward to an easily
						identified location:
					</Text>
					<Text style={[styles.bullets, { marginTop: 8 }]}>
						&#8226; have your tape measure handy
					</Text>
			...
			>
				...
				<CollapseBody style={styles.collapseBody}>
					<Text style={styles.bodyText}>
						Next, we need to compress the suspension and SLOWLY let
						up until it stops extending, allowing friction to stop
						the movement.
					</Text>
					<Text style={[styles.bullets, { marginTop: 8 }]}>
						&#8226; have your tape measure handy
			...
			>
				...
				<CollapseBody style={styles.collapseBody}>
					<Text style={styles.bodyText}>
						Next, we'll RAISE the bike and SLOWLY let it down until
						it stops settling, allowing friction to stop the
						movement.
					</Text>
					<Text style={[styles.bullets, { marginTop: 8 }]}>
						&#8226; have your tape measure handy
			...
			>
				...
				<CollapseBody style={styles.collapseBody}>
					<Text style={styles.bodyText}>
						As you remember, your actual sag is the average of L2
						and L3 subtracted from L1. Based on the measurements you
						provided:
					</Text>
					<Text style={[styles.bullets, { marginTop: 8 }]}>
						&#8226; L1: {l1}
					...
					<Text style={[styles.bodyText, { marginTop: 8 }]}>
						...
						travel ({front}
						mm in the front), you want your sag to be somewhere
					...
					<TouchableOpacity
						...
						onPress={() =>
							navigation.navigate('SetRearSag', route.params)
						}
					>
						<Text style={styles.toTextStyle}>
							Let's set your rear sag!
						</Text>
					</TouchableOpacity>
				</CollapseBody>
			</Collapse>
